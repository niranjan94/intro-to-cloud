...
export interface CalloutData {
  kind: CalloutKind;
  /** Short uppercase label, e.g. "Common mix-up #1". */
  tag: string;
...
/**
 * A left-barred callout used across the networking chapters to flag a common
 * misconception (myth), its correction (fix), or a provider-specific aside
 * (note): the same three roles the source explainers used.
 */
