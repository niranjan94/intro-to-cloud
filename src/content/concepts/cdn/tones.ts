/**
 * Semantic tones for the Content Delivery lesson. One palette carries the parts
 * of a delivery path (viewer, edge point of presence, a mid-tier cache, the
 * origin) and the outcome of a cache lookup (hit, miss, blocked). Meanings are
 * expressed in the app's calm light system as inline oklch utility classes, the
 * same technique diagram.tsx already uses.
 *
