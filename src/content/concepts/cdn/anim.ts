/**
 * Small animation helpers for the cache-trace simulator. Everything degrades to
 * an instant jump under prefers-reduced-motion. Kept local to this concept so
 ...
 * traced request path reads as a smooth wire rather than sharp zig-zags. Each
...
/** A short WAAPI "pop" (scale + fade in) for hit/miss markers. */
