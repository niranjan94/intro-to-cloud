/**
 * Semantic tones for the Object Storage lesson. Three vocabularies share one
 * palette: the parts of the namespace (container, object, metadata), the
 * temperature of a storage tier (frequent, infrequent, archive, auto), and the
 * outcome of an access check (allow, deny). Meanings are expressed in the app's
 * calm light system as inline oklch utility classes, the same technique
