...
import type { LifecycleContent } from "./data";
import { TONE } from "./tones";

/** Chapter 4: step an object through a lifecycle policy and watch tier and cost. */
      ...
      >
        ...
        <div className="mt-[16px]">
          <div className="flex items-center justify-between font-mono text-[11px] text-ink-muted">
            <span>Relative monthly storage cost</span>
            <span>{Math.round(step.costRel * 100)}%</span>
          </div>
          <div className="mt-[6px] h-[10px] overflow-hidden rounded-full bg-surface-muted">
            <div
              ...
              style={{ width: `${Math.round(step.costRel * 100)}%` }}
            />
          </div>
        </div>
