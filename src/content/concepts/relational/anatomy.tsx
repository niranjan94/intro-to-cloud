...
/** A clickable database part chip. */
function PartChip({
  part,
  selected,
  onSelect,
...
const LEGEND: { label: string; tone: keyof typeof TONE }[] = [
  { label: "engine", tone: "compute" },
  { label: "storage", tone: "storage" },
  { label: "backups", tone: "backup" },
  { label: "network", tone: "network" },
  { label: "firewall", tone: "security" },
  { label: "access", tone: "identity" },
];

/** Chapter 1: an interactive anatomy map of a managed database, with a detail panel. */
