 ...
 * the two things that must be true for the page to load: the load balancer has
 * an internet-facing front door, and the instance firewall allows traffic from
 * the load balancer. The private compute means the request never has a public
 * IP of its own to reach; it can only arrive through the balancer.
 *
    ...
    <div className="mt-[20px]">
      <div className="rounded-[16px] border border-line bg-surface-muted p-[14px]">
        <svg
          ...
          className="w-full"
          role="img"
          aria-label="A request travelling from a browser through the load balancer and instance firewall to nginx"
        >
          <line
            x1={centers[0]}
            y1={CY}
